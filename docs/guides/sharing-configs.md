...
**`envi.maml` encryption** (recommended — committed per-repo key):
...
### Method 1: `envi.maml` Encryption (Recommended)

**Best for:** Most team workflows. One-time setup, then sharing is fully automatic.
